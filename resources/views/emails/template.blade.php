						...
						<table bgcolor="#FFFFFF"  border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody">
							...
							<tr>
								<td align="center" valign="top">
									...
									-->
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#FFFFFF;" bgcolor="#b04ebb">
										<tr>
											<td align="center" valign="top">
												<!-- FLEXIBLE CONTAINER // -->
												<!--
													...
													<tr>
														<td align="center" valign="top" width="500" class="flexibleContainerCell">
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent" style="padding: 0px!important;">
																		<h2 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:25px;font-weight:normal;margin-bottom:5px;text-align:center;">DIPANDU APP</h2>
																		<h3 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:18px;margin-bottom:10px;color:#FFFFFF;line-height:135%;">{{ $params["subject"] }}</h3>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
																...
																<tr>
																	<td valign="top" bgcolor="#E1E1E1">
																		...
																		<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																			<div>Copyright &#169; 2018 <a href="https://dipanduapp.com" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">PANDU</span></a>. All&nbsp;rights&nbsp;reserved.</div>
																			<div>E-Mail ini dibuat oleh sistem, mohon tidak membalas E-Mail ini.</div>
																		</div>
